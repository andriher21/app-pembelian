    ...
    <div class="section-body section-emp-summary">
        <div class="row">
            ...
            <div class="col-12">
                <br>
                <div>
              <h6 class="m-0 font-weight-bold text-black">Daftar Suplier</h6>
                </div>
                <br>
              ...
              <div class="row mb-2">
                        <div class="col-4">
                            <div class="input-group">
                                <input type="text" id="searchbox" class="form-control" placeholder="Cari Suplier">
                            ...
                            <div class="btn-group group-action-area ">
                                <a href="<?= base_url('/suplier/create')?>"class="btn btn-danger btn-sm">
                                <i class="fas fa-fw fas fa-plus-circle"></i> Tambah Suplier</a>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped dataTable" width="100%" cellspacing="0" id="dataTable">
                                ...
                                <tbody>
                                        <?php $total = 0;foreach ($suplier as $u) : ?>
                                            <tr>
                                            <td><?= $u['kodespl']; ?></td>
                                           <td><?= $u['namaspl']; ?></td>
                                            
                                            <td><div class="btn-group">
                                                         <a href="<?= base_url('suplier/edit/'.$u['idspl'])?>" class="btn btn-outline-light " 
                                                         title="Edit Data" style="color:#4169E1;"><i class="fas fa-pen"></i></a>
                                                
                                                         <button class=" btn btn-outline-light"onclick="deleted(<?= $u['idspl']?>,'<?= $u['namaspl']?>')" title="Hapus Data"
