    ...
    <div class="section-body section-emp-summary">
        <div class="row">
            ...
            <div class="col-12">
                <br>
                <div>
              <h6 class="m-0 font-weight-bold text-black">Daftar Pembelian</h6>
                </div>
                <br>
              ...
              <div class="row mb-2">
                        <div class="col-4">
                            <div class="input-group">
                                <input type="text" id="searchbox" class="form-control" placeholder="Cari Pembelian by Suplier">
                            ...
                            <div class="btn-group group-action-area ">
                                <a href="<?= base_url('/pembelian/create')?>"class="btn btn-danger btn-sm"><i class="fas fa-fw fas fa-plus-circle"></i> Tambah Pembelian</a>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped dataTable" width="100%" cellspacing="0" id="dataTable">
                                ...
                                <tbody>
                                        <?php $total = 0;foreach ($pembelian as $u) : ?>
                                            <tr>
                                            <td><?= $u['notransaksi']; ?></td>
                                           <td><?= $u['kodespl']; ?></td>
                                           <td  ><?= $u['namaspl']; ?></td>
                                            ...
                                            <td><div class="btn-group">
                                                         <a href="<?= base_url('pembelian/edit/'.$u['idhbeli'])?>" class="btn btn-outline-light " 
                                                         title="Edit Data" style="color:#4169E1;"><i class="fas fa-pen"></i></a>
                                                
                                                         <button class=" btn btn-outline-light"onclick="deleted('<?= $u['notransaksi']?>','<?= $u['notransaksi']?>')" title="Hapus Data"
                                                          style="color:#FF0000;"><i class=" fas fa-trash"></i></button>
                                                          <a href="<?= base_url('pembelian/detail/'.$u['idhbeli'])?>" class="btn btn-outline-light " 
                                                             title="Detail Data" style="color:#4169E1;"><i class="fas fa-eye"></i></a>
